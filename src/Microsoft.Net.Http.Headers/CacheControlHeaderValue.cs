            ...
            List<NameValueHeaderValue> nameValueList)
        {
            for (var i = 0; i < nameValueList.Count; i++)
            {
                ...
                switch (name.Length)
                {
                    ...
                    case 7:
                        if (string.Equals(PrivateString, name, StringComparison.OrdinalIgnoreCase))
                        {
                            success = TrySetOptionalTokenList(nameValue, ref cc._private, ref cc._privateHeaders);
                        }
                        else if (string.Equals(MaxAgeString, name, StringComparison.OrdinalIgnoreCase))
                        {
                    ...
                    case 8:
                        if (string.Equals(SharedMaxAgeString, name, StringComparison.OrdinalIgnoreCase))
                        {
                            success = TrySetTimeSpan(nameValue, ref cc._sharedMaxAge);
                        }
                        else if (string.Equals(NoCacheString, name, StringComparison.OrdinalIgnoreCase))
                        {
